package com.test.build.repository;

import com.test.build.TestbuildApp;
import com.test.build.config.Constants;
import com.test.build.config.audit.AuditEventConverter;
import com.test.build.domain.PersistentAuditEvent;
...
import static com.test.build.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
